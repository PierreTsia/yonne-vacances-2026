...
**Ingrédients :**
- 1 paquet feuilles de lasagnes | 500ml lait, 50g beurre, 50g farine (Béchamel) | 150g Emmental râpé
- **Base commune :** Coulis tomate (800g), 2 oignons, 2 gousses d'ail.
...
3. **Montage :** Dans un plat, alterner : Sauce > Pâtes > Béchamel > Fromage.
...
**Préparation :**
1. **Préparation :** Toaster les pains 1 min. Laver salade/tomate.
2. **Cuisson :** Saisir les steaks (bœuf ou veggie) (3-4 min/face). Fondre fromage dessus en fin de cuisson.
...
**Préparation :**
1. **Légumes :** Couper courgettes et poivrons. Badigeonner avec la marinade.
2. **Cuisson :** *Viandes :* Griller 8-10 min. *Végé/Légumes :* Griller Halloumi, légumes et maïs (3-4 min/face).
3. **Service :** Servir immédiatement.
...
**Ingrédients :**
- 250g lentilles corail, 400ml lait de coco, 1 oignon, 2 c.à.s curry, coriandre, 3 naans.
...
- Sauce : 4 c.à.s soja, 1 c.à.s huile sésame, citron vert.

**Préparation :**
1. Assembler base quinoa + crudités.
...
**Préparation :**
1. Couper carottes en bâtonnets, oignon en quartiers, olives en rondelles.
...
3. Servir tortillas tièdes avec ingrédients au centre pour montage.
...
- **Omni :** 100g lardons (optionnels, à part).

**Préparation :**
1. Faire revenir les légumes.
2. Mélanger œufs/crème.
3. Garnir la pâte avec légumes (et lardons si Omni). Verser mélange.
...
**Ingrédients :**
- Légumes de saison (courge/brocoli), 400ml lait de coco, 2 c.à.s curry, 1 oignon.
- **Omni :** Poulet émincé (optionnel).

**Préparation :**
1. Faire revenir oignon/curry.
2. Ajouter légumes + lait de coco + 100ml eau. Mijoter 20 min.
3. Cuire poulet à part (Omni). Servir.
...
**Ingrédients :**
- 9 œufs, 300g champignons de Paris, 30g beurre, persil/ciboulette, 1 salade verte.

**Préparation :**
1. **Champignons :** Saisir les champignons émincés dans une poêle avec beurre et persil. Réserver.
